...
private  String value1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String value1 = intent2.getStringExtra("tel");
        Toast.makeText(this, "Permission :" + value1, Toast.LENGTH_SHORT).show();
    ...
    public void sendMySMS() {
        ...
        String value1 = intent2.getStringExtra("tel");
        String phone = value1;
        Toast.makeText(this, "Permission : "+ phone, Toast.LENGTH_SHORT).show();
    ...
    private void showMessageOKCancel(String message, DialogInterface.OnClickListener okListener) {
        new android.support.v7.app.AlertDialog.Builder(sendingmessage.this)
                .setMessage(message)
